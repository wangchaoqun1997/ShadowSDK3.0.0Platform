...
namespace ShadowKit
{
	public class RegisterAndroidListener : AndroidJavaProxy
	{
		
		public RegisterAndroidListener(): base("com.invision.unity.callback.LoginSystemCallback")  
		{
		}
...
//				ShadowSystem.PaySystem.pay ("10001", 1, PayType.WEIXIN, payCallback);
		...
		{
			Debug.Log ("RegisterAndroidListener.unityLoginAndRegister=====>");
