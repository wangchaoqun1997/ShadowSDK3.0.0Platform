    ...
    class LoginPhoneAndVerificationCodeUI:LoginBaseUI {
        ...
        public override void Login() {
            ...
            if (loginNameInputField.textCompontent.text == String.Empty || loginPasswordInputField.textCompontent.text == String.Empty) {
                ...
                PlatformUISystem.Instant.uiPanelsManager.PushUIPanel(Scripts.UIPanelsType.InfoType1Panel, "手机号或验证码不能为空");
                return;
            }
            LoginManager.SetLoginType(new LoginPhoneAndVerificationCode());
